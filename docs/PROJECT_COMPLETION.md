...
| `npm run build` | 通过 | 2026-08-25；Phase B5 Web + server；主 JS 744.72 kB / gzip 237.73 kB，server 295.3 kB；既有 >500 kB 警告留待 Phase F |
