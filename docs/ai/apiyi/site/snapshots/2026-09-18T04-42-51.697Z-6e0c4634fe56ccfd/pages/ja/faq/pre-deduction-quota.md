...
<CardGroup cols={2}>
  <Card title="残高があるのに実行できないのはなぜですか？" icon="credit-card" href="/ja/faq/balance-insufficient">
    残高不足に関する完全なトラブルシューティングと解決策です。
  </Card>

  <Card title="max_tokens の設定方法" icon="ruler" href="/ja/faq/max-tokens">
    出力長を制御します。事前差し引き額の見積もりに影響します。
  </Card>

  <Card title="task_id で動画タスクの実際の料金を確認する" icon="receipt" href="/ja/faq/seedance-task-cost-lookup">
    事前チャージおよび精算のログエントリと、タスクのクォータとの関係を説明します。
  </Card>

  <Card title="token の課金モード" icon="coins" href="/ja/faq/token-billing-modes">
    使用量に基づく精算の仕組みを理解できます。
  </Card>

  <Card title="支払い方法" icon="credit-card" href="/ja/faq/payment-methods">
    残高が少ない場合にすばやくチャージする方法です。
  </Card>
</CardGroup>
