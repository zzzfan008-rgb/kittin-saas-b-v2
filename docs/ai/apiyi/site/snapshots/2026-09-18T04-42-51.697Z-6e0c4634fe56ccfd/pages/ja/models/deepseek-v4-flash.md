...
<CardGroup cols={2}>
  <Card title="リリース発表" icon="megaphone" href="/en/news/deepseek-v4-flash-ga-launch">
...
<Note>このページの仕様は`models/data/model-details.json`で手動管理されています。価格とエンドポイントは最新の価格 API から取得され、ビルドのたびに更新されます。</Note>
