...
> GoogleのGemini 3.6 Flashマルチモーダルモデル：1Mコンテキスト、4段階の推論レベル、完全なネイティブツールスイート。APIYIでは、公式料金でネイティブGeminiエンドポイントとOpenAI互換エンドポイントの両方を提供しています — 100万tokensあたり入力$1.50／出力$7.50。
