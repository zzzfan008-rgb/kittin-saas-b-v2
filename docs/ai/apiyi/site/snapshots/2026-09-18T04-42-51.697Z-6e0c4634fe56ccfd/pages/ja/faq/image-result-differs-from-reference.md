...
<CardGroup cols={2}>
  <Card title="Nano Banana 画像生成の失敗" icon="banana" href="/ja/faq/nano-banana-image-failure">
    Nano Banana モデルに関する一般的な問題と解決策です。
  </Card>

  <Card title="画像非同期 API" icon="loader" href="/ja/faq/image-async-api">
    画像非同期タスクエンドポイントの使用方法です。
  </Card>

  <Card title="ベース URL の設定方法" icon="link" href="/ja/faq/base-url-config">
    さまざまなクライアントツールで APIYI に接続します。
  </Card>

  <Card title="token モデルホワイトリスト" icon="key" href="/ja/faq/token-model-whitelist">
