...
> APIYI の Gemini 3.5 Flash-Lite：100万 tokens あたり入力 $0.3 / 出力 $2.4999、コンテキストウィンドウ 1,048,576、最大出力 65,536、3つの課金グループで利用可能です。
...
<CardGroup cols={2}>
  <Card title="リリース告知" icon="megaphone" href="/en/news/gemini-3-6-flash-lite-launch">
  ...
  <Card title="モデルの料金ディレクトリ" icon="table" href="/en/models">
