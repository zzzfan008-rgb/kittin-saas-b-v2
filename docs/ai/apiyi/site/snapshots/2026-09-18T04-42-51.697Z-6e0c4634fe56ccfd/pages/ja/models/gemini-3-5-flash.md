...
> APIYI上のGemini 3.5 Flash：100万tokenあたり入力$1.5／出力$9、コンテキストウィンドウ1,000,000、最大出力64,000、3つの課金グループで利用可能です。
...
一部のグループには追加割引があり、チャージボーナスと併用できます。[トークンとグループ](/ja/faq/token-and-groups)をご覧ください。
...
<CardGroup cols={2}>
  <Card title="リリースのお知らせ" icon="megaphone" href="/en/news/gemini-3-5-flash-launch">
    Gemini 3.5 Flash の背景、ベンチマーク、移行に関する注意事項
  </Card>
