...
<CardGroup cols={2}>
  <Card title="リリース発表" icon="megaphone" href="/en/news/minimax-m3-launch">
    MiniMax-M3 の背景、ベンチマーク、移行に関する注記
  </Card>
...
<Note>このページの仕様は`models/data/model-details.json`で手動管理されています。料金とエンドポイントはライブ料金 API から取得され、ビルドのたびに更新されます。</Note>
