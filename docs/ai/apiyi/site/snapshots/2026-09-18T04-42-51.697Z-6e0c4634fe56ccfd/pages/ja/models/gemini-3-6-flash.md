...
> APIYI の Gemini 3.6 Flash：100万 tokens あたり入力 $1.5 / 出力 $7.5、コンテキストウィンドウ 1,048,576、最大出力 65,536、3つの課金グループで利用可能。
...
<CardGroup cols={2}>
  ...
  <Card title="Gemini 3.6 Flash の概要" icon="book-open" href="/ja/api-capabilities/gemini-3-6-flash/overview">
