...
| 模型                                                         | 企业分组名                  | 倍率   | 通道性质                                                                                |
| ---------------------------------------------------------- | ---------------------- | ---- | ----------------------------------------------------------------------------------- |
| gpt-image-2.5-flare / gpt-image-2.5-sunburst / gpt-image-2 | `image2Enterprise`     | 1.2x | **OpenAI 上游**企业兜底（[实时动态 · 2026-05-13](/live/2026-05/gpt-image-2-default-saturated)） |
