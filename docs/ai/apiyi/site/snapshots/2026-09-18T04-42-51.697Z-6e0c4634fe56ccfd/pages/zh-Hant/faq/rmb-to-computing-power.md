...
> API易僅提供模型服務與對應定價，人民幣充值按固定匯率 1 美元 = 7 元人民幣換算；算力兌換比例由客戶系統自行決定。
...
人民幣充值採用固定匯率：**1 美元 = 7 元人民幣**，不隨即時匯率波動。

GPT 價格方面，**官轉版**價格與官方一致；**官逆版**按次計費，價格更優惠。

<Info>
  換算示例：按固定匯率 1:7，200 美元對應 1400 元人民幣（200 × 7 = 1400）。
</Info>
