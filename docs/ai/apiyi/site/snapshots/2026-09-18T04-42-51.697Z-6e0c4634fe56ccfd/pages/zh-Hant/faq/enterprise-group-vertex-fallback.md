...
| 模型                                                         | 企業分組名                  | 倍率   | 通道性質                                                                                |
| ---------------------------------------------------------- | ---------------------- | ---- | ----------------------------------------------------------------------------------- |
| gpt-image-2.5-flare / gpt-image-2.5-sunburst / gpt-image-2 | `image2Enterprise`     | 1.2x | **OpenAI 上游**企業兜底（[即時動態 · 2026-05-13](/live/2026-05/gpt-image-2-default-saturated)） |
