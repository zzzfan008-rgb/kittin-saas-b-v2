...
| [**gpt-image-2.5-flare**](/zh-Hant/api-capabilities/gpt-image-2/overview) 🆕                        | 2026-09 新上線，官轉 | OpenAI GPT-Image 2.5 速度優先版：畫質高於 gpt-image-2、時延最多低 50%，size/quality 精確控（新增 `xhigh` / `max`），參考圖自動高保真、支援 mask 局部重繪          | 1K/2K/**4K**（任意合法尺寸）                | 按 token 計費，與 gpt-image-2 同價，充值活動 85 折左右 |
| [**gpt-image-2.5-sunburst**](/zh-Hant/api-capabilities/gpt-image-2/overview) 🆕                     | 2026-09 新上線，官轉 | OpenAI GPT-Image 2.5 畫質與編輯精度優先版：多輪編輯、主體保留更強，引數同 flare                                                                     | 1K/2K/**4K**（任意合法尺寸）                | 按 token 計費，與 gpt-image-2 同價             |
| [**gpt-image-2**](/zh-Hant/api-capabilities/gpt-image-2/overview)                                   | 官轉，上一代         | OpenAI 官轉、size/quality 精確控（到 `high`）、參考圖自動高保真、支援 mask 局部重繪                                                                | 1K/2K/**4K**（任意合法尺寸）                | 按 token 計費，預設原價，充值活動 85 折左右             |
...
| [**gpt-image-2.5-flare-vip / sunburst-vip**](/zh-Hant/api-capabilities/gpt-image-2-vip/overview) 🆕 | 2026-09 新上線，官逆 | GPT-Image 2.5 的 Adobe 線逆向版：呼叫同 -vip、`size` 鎖 30 檔含 **4K**，另支援 `quality` 六檔（含 `xhigh` / `max`）與透明背景；別名 `gpt-image-2.5-vip` | 1K/2K/**4K**（30 檔統一價）               | \$0.03/張（按次）                            |
| [**gpt-image-2-vip**](/zh-Hant/api-capabilities/gpt-image-2-vip/overview)                           | 官逆             | GPT 官逆 Adobe 線（Firefly）、呼叫同 -all、`size` 欄位鎖尺寸、30 檔常見 size 含 **4K**、約 90–150s 出圖                                           | 1K/2K/**4K**（30 檔統一價）               | \$0.03/張（按次，4K 不加價）                     |
...
<Tip>
  ...
  * [gpt-image-2-vip 文件](/zh-Hant/api-capabilities/gpt-image-2-vip/overview) - GPT 官逆 Adobe 線（Firefly），\$0.03/張、30 檔 size 含 4K、約 90–150s 出圖
  * [GPT-Image-2.5 / 2 文件](/zh-Hant/api-capabilities/gpt-image-2/overview) - OpenAI 官轉三款（2.5-flare / 2.5-sunburst / 2）、原生 4K、size/quality 精確控
