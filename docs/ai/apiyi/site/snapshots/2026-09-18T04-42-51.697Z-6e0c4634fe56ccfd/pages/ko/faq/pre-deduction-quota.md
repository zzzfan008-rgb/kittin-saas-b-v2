...
<CardGroup cols={2}>
  <Card title="잔액이 있는데도 왜 실행되지 않나요?" icon="credit-card" href="/ko/faq/balance-insufficient">
    잔액 부족에 대한 전체 문제 해결 방법 및 수정 방법입니다.
  </Card>

  <Card title="max_tokens는 어떻게 설정하나요?" icon="ruler" href="/ko/faq/max-tokens">
    사전 차감 추정치에 영향을 주는 출력 길이를 제어합니다.
  </Card>

  <Card title="task_id로 동영상 작업의 실제 비용 조회" icon="receipt" href="/ko/faq/seedance-task-cost-lookup">
    사전 청구 및 정산 로그 항목이 작업의 쿼터와 어떤 관계인지 설명합니다.
  </Card>

  <Card title="Token 과금 모드" icon="coins" href="/ko/faq/token-billing-modes">
    사용량 기반 정산 방식의 작동 원리를 알아봅니다.
  </Card>

  <Card title="결제 수단" icon="credit-card" href="/ko/faq/payment-methods">
    잔액이 부족할 때 신속하게 충전하는 방법입니다.
  </Card>
</CardGroup>
