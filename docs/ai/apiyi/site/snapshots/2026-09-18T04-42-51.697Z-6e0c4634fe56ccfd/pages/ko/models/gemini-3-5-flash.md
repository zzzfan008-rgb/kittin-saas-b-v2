...
> APIYI의 Gemini 3.5 Flash: 100만 tokens당 입력 $1.5 / 출력 $9, 컨텍스트 1,000,000, 최대 출력 64,000, 3개 과금 그룹에서 사용 가능합니다.
...
<CardGroup cols={2}>
  <Card title="출시 발표" icon="megaphone" href="/en/news/gemini-3-5-flash-launch">
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리됩니다. 과금 및 엔드포인트는 실시간 과금 API에서 가져오며, 재빌드할 때마다 새로 고쳐집니다.</Note>
