...
<CardGroup cols={2}>
  <Card title="출시 발표" icon="megaphone" href="/en/news/qwen-3-7-max-launch">
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리되며, 가격과 엔드포인트는 실시간 가격 API에서 가져와 모든 재빌드마다 새로 고칩니다.</Note>
