...
<CardGroup cols={2}>
  <Card title="출시 공지" icon="megaphone" href="/en/news/glm-5-2-launch">
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리되며, 과금 및 엔드포인트는 실시간 과금 API에서 가져와 모든 재빌드 시 새로 고쳐집니다.</Note>
