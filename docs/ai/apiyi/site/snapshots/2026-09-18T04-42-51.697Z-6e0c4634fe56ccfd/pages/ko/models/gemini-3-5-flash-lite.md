...
> APIYI의 Gemini 3.5 Flash-Lite: 100만 tokens당 입력 $0.3 / 출력 $2.4999, 1,048,576 컨텍스트, 최대 출력 65,536, 3개의 과금 그룹에서 이용 가능합니다.
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리되며, 가격 및 엔드포인트는 실시간 가격 API에서 가져와 빌드할 때마다 새로 고쳐집니다.</Note>
