...
<CardGroup cols={2}>
  ...
  <Card title="추론 강도 및 사고" icon="book-open" href="/ko/api-capabilities/claude-effort-thinking">
    매개변수, 사용법 및 모범 사례
  </Card>
  ...
  <Card title="모델 요금 디렉터리" icon="table" href="/en/models">
    모든 모델의 최신 요금, 엔드포인트 및 그룹
  </Card>
</CardGroup>

<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리되며, 요금과 엔드포인트는 최신 요금 API에서 가져와 빌드할 때마다 새로 고쳐집니다.</Note>
