...
> APIYI의 Gemini 3.7 Flash: 토큰 100만 개당 입력 $0.75 / 출력 $3.75, 컨텍스트 윈도우 1,000,000, 최대 출력 64,000, 3개 과금 그룹에서 제공됩니다.
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리하며, 과금 및 엔드포인트는 실시간 과금 API에서 가져와 모든 빌드마다 새로 고칩니다.</Note>
