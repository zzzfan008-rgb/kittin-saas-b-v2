...
> APIYI의 Gemini 3.6 Flash: 1M tokens당 입력 $1.5 / 출력 $7.5, 1,048,576 컨텍스트, 최대 출력 65,536, 3개의 과금 그룹에서 이용할 수 있습니다.
...
<CardGroup cols={2}>
  <Card title="출시 공지" icon="megaphone" href="/en/news/gemini-3-6-flash-lite-launch">
    Gemini 3.6 Flash의 배경, 벤치마크 및 마이그레이션 참고 사항
  </Card>

  <Card title="Gemini 3.6 Flash 개요" icon="book-open" href="/ko/api-capabilities/gemini-3-6-flash/overview">
    매개변수, 사용법 및 모범 사례
  </Card>
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리되며, 과금 및 엔드포인트는 실시간 과금 API에서 가져와 빌드할 때마다 새로 고쳐집니다.</Note>
