...
> APIYI의 Grok 4.6: 100만 tokens당 입력 $2 / 출력 $6, 500,000 컨텍스트, 3개 과금 그룹에서 사용 가능합니다.
...
일부 그룹에는 충전 보너스와 중복 적용 가능한 추가 할인 혜택이 있습니다. [tokens 및 그룹](/ko/faq/token-and-groups)을 참조하십시오.
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리되며, 과금 및 엔드포인트는 실시간 과금 API에서 가져와 모든 다시 빌드 시 새로 고쳐집니다.</Note>
