...
| [**gpt-image-2.5-flare**](/api-capabilities/gpt-image-2/overview) 🆕                        | 2026-09 新上线，官转 | OpenAI GPT-Image 2.5 速度优先版：画质高于 gpt-image-2、时延最多低 50%，size/quality 精确控（新增 `xhigh` / `max`），参考图自动高保真、支持 mask 局部重绘          | 1K/2K/**4K**（任意合法尺寸）                | 按 token 计费，与 gpt-image-2 同价，充值活动 85 折左右 |
| [**gpt-image-2.5-sunburst**](/api-capabilities/gpt-image-2/overview) 🆕                     | 2026-09 新上线，官转 | OpenAI GPT-Image 2.5 画质与编辑精度优先版：多轮编辑、主体保留更强，参数同 flare                                                                     | 1K/2K/**4K**（任意合法尺寸）                | 按 token 计费，与 gpt-image-2 同价             |
| [**gpt-image-2**](/api-capabilities/gpt-image-2/overview)                                   | 官转，上一代         | OpenAI 官转、size/quality 精确控（到 `high`）、参考图自动高保真、支持 mask 局部重绘                                                                | 1K/2K/**4K**（任意合法尺寸）                | 按 token 计费，默认原价，充值活动 85 折左右             |
...
| [**gpt-image-2.5-flare-vip / sunburst-vip**](/api-capabilities/gpt-image-2-vip/overview) 🆕 | 2026-09 新上线，官逆 | GPT-Image 2.5 的 Adobe 线逆向版：调用同 -vip、`size` 锁 30 档含 **4K**，另支持 `quality` 六档（含 `xhigh` / `max`）与透明背景；别名 `gpt-image-2.5-vip` | 1K/2K/**4K**（30 档统一价）               | \$0.03/张（按次）                            |
| [**gpt-image-2-vip**](/api-capabilities/gpt-image-2-vip/overview)                           | 官逆             | GPT 官逆 Adobe 线（Firefly）、调用同 -all、`size` 字段锁尺寸、30 档常见 size 含 **4K**、约 90–150s 出图                                           | 1K/2K/**4K**（30 档统一价）               | \$0.03/张（按次，4K 不加价）                     |
...
<Tip>
  ...
  * [gpt-image-2-vip 文档](/api-capabilities/gpt-image-2-vip/overview) - GPT 官逆 Adobe 线（Firefly），\$0.03/张、30 档 size 含 4K、约 90–150s 出图
  * [GPT-Image-2.5 / 2 文档](/api-capabilities/gpt-image-2/overview) - OpenAI 官转三款（2.5-flare / 2.5-sunburst / 2）、原生 4K、size/quality 精确控
