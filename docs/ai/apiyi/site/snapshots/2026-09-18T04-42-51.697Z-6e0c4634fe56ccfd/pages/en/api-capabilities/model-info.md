...
| -------------------- | --------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| **GPT-5.6 Sol** 🔥   | `gpt-5.6-sol`   | 1M             | 5.6-gen flagship, Terminal-Bench 2.1 **88.8%**, BrowseComp 90.4%; the `gpt-5.6` alias points here; \$4/\$20 (price cut 3 Sep) | Frontier intelligence, agent tasks           |
