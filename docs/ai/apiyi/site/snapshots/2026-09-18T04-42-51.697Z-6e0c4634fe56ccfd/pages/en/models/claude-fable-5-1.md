...
> Claude Fable 5.1 on APIYI: $10 input / $50 output per 1M tokens, 1,000,000 context, 128,000 max output, available in 4 billing groups.

The first iteration of the Mythos-class flagship: input and output prices hold while cache reads drop to a quarter; inputs and outputs are retained for 30 days for abuse detection.
...
| Model ID                    | Notes                                                                                       |
| --------------------------- | ------------------------------------------------------------------------------------------- |
| `claude-fable-5-1`          | Standard call.                                                                              |
| `claude-fable-5-1-thinking` | Forced-thinking variant; pricing, endpoints and groups all identical to the standard model. |
...
<CardGroup cols={2}>
  <Card title="Launch announcement" icon="megaphone" href="/en/news/claude-fable-5-1-launch">
    Background, benchmarks and migration notes for Claude Fable 5.1
  </Card>
