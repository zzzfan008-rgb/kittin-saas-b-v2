...
> Qwen3.8-Flash on APIYI: $0.114 input / $0.3876 output per 1M tokens, 1,000,000 context, 131,072 max output, available in 2 billing groups.
...
The example below calls `qwen3.8-flash` through OpenAI Chat Completions (`/v1/chat/completions`). Point base\_url at `https://api.apiyi.com/v1` — everything else matches the official API.
...
<CardGroup cols={2}>
  <Card title="Qwen3.7-Flash" icon="git-compare" href="/en/models/qwen3-7-flash">
    Details for a model in the same family
  </Card>

  <Card title="Qwen3.8-27B" icon="git-compare" href="/en/models/qwen3-8-27b">
    Details for a model in the same family
  </Card>
