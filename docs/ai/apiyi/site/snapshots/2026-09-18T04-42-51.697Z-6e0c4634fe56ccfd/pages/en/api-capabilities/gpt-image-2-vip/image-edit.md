...
| -------- | ---- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `model`  | text | Yes      | `gpt-image-2.5-vip` (= `gpt-image-2.5-sunburst-vip`) / `gpt-image-2.5-flare-vip` / previous-generation `gpt-image-2-vip`, same price and call format; `mask` is whole-image regeneration on all three  |
