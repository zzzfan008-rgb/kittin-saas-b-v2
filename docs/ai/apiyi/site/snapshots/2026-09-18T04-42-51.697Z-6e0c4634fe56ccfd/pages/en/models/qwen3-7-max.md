...
> Qwen3.7-Max on APIYI: $1.714 input / $5.142 output per 1M tokens, 1,000,000 context, available in 3 billing groups.

Top-five worldwide and first among Chinese models on the AA intelligence index (56.6), with autonomous agent runs on the order of 35 hours.
...
The example below calls `qwen3.7-max` through OpenAI Chat Completions (`/v1/chat/completions`). Point base\_url at `https://api.apiyi.com/v1` — everything else matches the official API.
...
<CardGroup cols={2}>
  <Card title="Launch announcement" icon="megaphone" href="/en/news/qwen-3-7-max-launch">
    Background, benchmarks and migration notes for Qwen3.7-Max
  </Card>
