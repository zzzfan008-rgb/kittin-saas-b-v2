...
<div className="columns-1 sm:columns-2 lg:columns-3 gap-4 [&>*]:mb-4 [&>*]:break-inside-avoid mt-8">
  <Frame caption="**Tool-vendor developer · WeChat · 2026-09-10** — They wired APIYI's `gpt-image-2.5-flare` into the image-generation panel of their own software and sent over a fresh cartoon fox sticker it had just produced. We replied with a quick 'sounds good' and the gpt-image-2 docs link, and they added: 'I built it into my software exactly the way your docs describe. Thank goodness for those docs, otherwise my head would be spinning.' Clear docs are the least stressful support we can offer a developer.">
    <img src="https://mintcdn.com/apiyillc/_vxXqILQbMh4L0rf/images/wall-of-love/wechat-toolmaker-docs-into-software.png?fit=max&auto=format&n=_vxXqILQbMh4L0rf&q=85&s=6da13b2c574e0170137ee2853692a8e6" alt="WeChat exchange: a tool-vendor developer shows a fox sticker generated in their software with gpt-image-2.5-flare and says the APIYI docs are what made the integration possible" width="1110" height="940" data-path="images/wall-of-love/wechat-toolmaker-docs-into-software.png" />
  </Frame>
