...
<AccordionGroup>
  ...
  <Accordion title="I logged in via a third party (GitHub/WeChat). What should I do?">
    Third-party login users should log in directly through the corresponding platform. If you're having trouble with third-party login, see [GitHub Login Issues](/en/faq/github-bindng-bindng-error) or contact support.
  </Accordion>
