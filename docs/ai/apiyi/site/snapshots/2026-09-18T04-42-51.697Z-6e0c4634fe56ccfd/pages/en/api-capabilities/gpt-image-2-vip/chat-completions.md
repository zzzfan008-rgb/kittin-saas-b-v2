...
| -------------------- | --------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `model`              | string          | Yes      | `gpt-image-2.5-vip` (= `gpt-image-2.5-sunburst-vip`) / `gpt-image-2.5-flare-vip` / previous-generation `gpt-image-2-vip`                                                                     |
...
info:
  ...
  description: >
    ...
    Firefly) — chat-based endpoint (OpenAI Chat Completions compatible).
