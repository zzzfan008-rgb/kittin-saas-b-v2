...
> HappyHorse-1.1-r2v Reference-to-Video API reference and online debugging: up to 9 reference images to keep the subject and scene consistent, DashScope async passthrough endpoint.
...
<CodeGroup>
  ...
  ```python Python (single reference image) theme={null}
  import requests
  ...
  ```python Python (multiple reference images, up to 9) theme={null}
  import requests
...
| -------------------------- | ------ | -------- | ------- | ------------------------------- |
| `model`                    | string | ✓        | —       | Fixed to `happyhorse-1.1-r2v`   |
...
| ----------------- | -------- | ----- | ---------------------------------------------------------------------------- |
| `reference_image` | ✓        | 1–9   | Reference image; preserves subject (person/animal/object) and scene features |
