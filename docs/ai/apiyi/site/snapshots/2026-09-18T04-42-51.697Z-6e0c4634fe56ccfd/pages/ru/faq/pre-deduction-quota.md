...
<CardGroup cols={2}>
  <Card title="Почему запрос не выполняется, несмотря на наличие баланса?" icon="credit-card" href="/ru/faq/balance-insufficient">
    Полное руководство по устранению проблем и исправлению недостаточного баланса.
  </Card>

  <Card title="Как задать max_tokens?" icon="ruler" href="/ru/faq/max-tokens">
    Управление длиной вывода, которая влияет на предварительную оценку списания.
  </Card>

  <Card title="Узнайте фактическую стоимость видеозадачи по task_id" icon="receipt" href="/ru/faq/seedance-task-cost-lookup">
    Взаимосвязь записей о предварительном списании и окончательном расчёте с квотой задачи.
  </Card>

  <Card title="Режимы тарификации token" icon="coins" href="/ru/faq/token-billing-modes">
    Узнайте, как работает расчёт на основе использования.
  </Card>

  <Card title="Способы оплаты" icon="credit-card" href="/ru/faq/payment-methods">
    Как быстро пополнить баланс при его недостаточном объёме.
  </Card>
</CardGroup>
