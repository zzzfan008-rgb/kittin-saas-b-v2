...
# Справочник API чата Gemini 3.6 Flash

> Справочник API завершения чата Gemini 3.6 Flash и интерактивная песочница: совместимость с OpenAI, уровни reasoning_effort, потоковая передача, вызов функций и поддержка изображений.
