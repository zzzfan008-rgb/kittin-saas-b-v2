...
> Gemini 3.6 Flash 模型详情：输入 $1.5 / 输出 $7.5 每 1M tokens，1,048,576 上下文、65,536 最大输出，2 个分组可用。
...
<CardGroup cols={2}>
  ...
  <Card title="概览" icon="book-open" href="/api-capabilities/gemini-3-6-flash/overview">
    参数、调用方式与最佳实践
  </Card>
