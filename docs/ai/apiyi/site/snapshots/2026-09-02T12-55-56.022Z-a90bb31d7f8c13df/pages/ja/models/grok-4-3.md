...
> APIYI の Grok 4.3: 入力は 1M tokens あたり $1.25、出力は 1M tokens あたり $2.5、コンテキストウィンドウは 1,000,000、4 つの課金グループで利用できます。
...
<Note>このページの仕様は`models/data/model-details.json`で手動管理されています。料金とエンドポイントはライブ料金 API から取得され、2026-08-31 11:46 (UTC+8) に更新されています。仕様の最終確認日は 2026-07-31 です。</Note>
