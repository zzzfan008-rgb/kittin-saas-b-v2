...
一部のグループには追加割引があり、チャージ特典と併用可能です。[Tokens とグループ](/ja/faq/token-and-groups)をご覧ください。
...
<CardGroup cols={2}>
  <Card title="ローンチのお知らせ" icon="megaphone" href="/en/news/claude-opus-5-launch">
  ...
  <Card title="推論の強度とThinking" icon="book-open" href="/ja/api-capabilities/claude-effort-thinking">
    パラメータ、使用方法、ベストプラクティス
  </Card>
  ...
  <Card title="モデル価格一覧" icon="table" href="/en/models">
    283モデルすべての最新の価格情報、エンドポイント、グループ
  </Card>
</CardGroup>

<Note>このページの仕様は`models/data/model-details.json`で手動管理されています。価格情報とエンドポイントは、2026-08-31 11:46 (UTC+8) に更新された最新の価格情報 API から取得しています。仕様の最終確認日は2026-07-31です。</Note>
