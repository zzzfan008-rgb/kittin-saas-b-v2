...
> APIYI の Grok 4.6: 1M tokens あたり入力 $2 / 出力 $6、コンテキストウィンドウ 500,000、4 つの課金グループで利用できます。
...
<CardGroup cols={2}>
  <Card title="発表" icon="megaphone" href="/en/news/grok-4-6-launch">
...
<Note>このページの仕様は`models/data/model-details.json`で手動管理されています。料金とエンドポイントはライブ料金 API から取得され、2026-08-31 11:46 (UTC+8) に更新されています。仕様の最終確認日は2026-08-13です。</Note>
