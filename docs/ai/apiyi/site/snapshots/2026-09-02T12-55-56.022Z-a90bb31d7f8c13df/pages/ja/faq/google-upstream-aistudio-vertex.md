...
<CardGroup cols={2}>
  <Card title="Nano Banana 開発者ガイド" icon="book-open" href="/ja/api-capabilities/nano-banana-dev-guide">
    AIStudio + Vertex のデュアルチャネル冗長化メカニズムを含む、Nano Banana の完全な利用ガイドです。
  </Card>
  ...
  <Card title="ライブ更新アーカイブ" icon="radio" href="/en/live/archive">
    日次のプラットフォーム稼働状況、チャネル切り替え、インシデント復旧のタイムラインです。
  </Card>

  <Card title="Tokens とグループ" icon="key" href="/ja/faq/token-and-groups">
    デフォルト グループとフォールバック グループ向けの token グループとルールです。
  </Card>
</CardGroup>

<Tip>
  **さらに必要ですか？** この記事で扱っていない情報 — Vertex / AIStudio のスケジューリング詳細、上流コンピュートプールの容量、SLA — については、WeCom カスタマーサービスまたは [hi@apiyi.com](mailto:hi@apiyi.com) までメールでお問い合わせください。
</Tip>
