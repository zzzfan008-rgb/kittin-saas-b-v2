...
> Gemini 3.6 Flash on APIYI: $1.5 input / $7.5 output per 1M tokens, 1,048,576 context, 65,536 max output, available in 2 billing groups.
...
<CardGroup cols={2}>
  ...
  <Card title="Overview" icon="book-open" href="/en/api-capabilities/gemini-3-6-flash/overview">
