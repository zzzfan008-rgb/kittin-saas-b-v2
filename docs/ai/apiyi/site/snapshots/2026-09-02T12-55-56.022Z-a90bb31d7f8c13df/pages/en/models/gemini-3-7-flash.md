...
> Gemini 3.7 Flash on APIYI: $0.75 input / $3.75 output per 1M tokens, 1,000,000 context, 64,000 max output, available in 2 billing groups.
...
The example below calls `gemini-3.7-flash` through OpenAI Chat Completions (`/v1/chat/completions`). Point base\_url at `https://api.apiyi.com/v1` — everything else matches the official API.
...
<CardGroup cols={2}>
  <Card title="Launch announcement" icon="megaphone" href="/en/news/gemini-3-7-flash-launch">
