...
<Tip>
  When troubleshooting, first inspect the token's "Select group" and "Fallback group" settings — don't go hunting for "my account's group". See [Tokens & Groups](/faq/token-and-groups).
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Model availability" icon="list" href="/faq/model-availability">
