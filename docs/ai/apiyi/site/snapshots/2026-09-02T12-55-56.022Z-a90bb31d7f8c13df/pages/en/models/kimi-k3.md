...
> Kimi K3 on APIYI: $3 input / $15 output per 1M tokens, 1,048,576 context, 131,072 max output, available in 2 billing groups.

A 2.8-trillion-parameter open-weight flagship that tops the LMArena frontend-code board, with flat pricing across the whole context range.
...
The example below calls `kimi-k3` through OpenAI Chat Completions (`/v1/chat/completions`). Point base\_url at `https://api.apiyi.com/v1` — everything else matches the official API.
...
<CardGroup cols={2}>
  <Card title="Launch announcement" icon="megaphone" href="/en/news/kimi-k3-launch">
    Background, benchmarks and migration notes for Kimi K3
  </Card>

  <Card title="Kimi K2.5" icon="book-open" href="/en/api-capabilities/kimi-k2-5">
