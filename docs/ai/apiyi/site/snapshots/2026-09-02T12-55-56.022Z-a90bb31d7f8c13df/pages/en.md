...
<CardGroup cols={2}>
  ...
  <Card title="gpt-image-2 Series" icon="images" href="/en/api-capabilities/gpt-image-2/vs-gpt-image-2-all">
    OpenAI official relay with native 4K + reverse -all/-vip at \$0.03/image — pick what fits
  </Card>
