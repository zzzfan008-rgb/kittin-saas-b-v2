...
> Gemini 3.6 Flash 模型詳情：輸入 $1.5 / 輸出 $7.5 每 1M tokens，1,048,576 上下文、65,536 最大輸出，2 個分組可用。
...
<CardGroup cols={2}>
  ...
  <Card title="概覽" icon="book-open" href="/zh-Hant/api-capabilities/gemini-3-6-flash/overview">
    引數、呼叫方式與最佳實踐
  </Card>
