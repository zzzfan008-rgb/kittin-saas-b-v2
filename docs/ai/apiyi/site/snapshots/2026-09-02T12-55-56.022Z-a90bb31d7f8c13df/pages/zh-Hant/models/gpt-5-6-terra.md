...
> GPT-5.6 Terra 模型詳情：輸入 $2 / 輸出 $12 每 1M tokens，1,000,000 上下文，4 個分組可用。

GPT-5.6 系列主力檔，對標 GPT-5.5 的效能但價格減半，存量遷移首選。
...
* 0 – 272,000 tokens 輸入 \$2/1M
* 超過 272,000 tokens 輸入 \$4/1M
...
以下示例通過 OpenAI Chat Completions（`/v1/chat/completions`）呼叫 `gpt-5.6-terra`。base\_url 換成 `https://api.apiyi.com/v1` 即可，其餘用法與官方一致。
