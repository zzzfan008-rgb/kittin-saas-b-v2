...
> Kimi K3 模型詳情：輸入 $3 / 輸出 $15 每 1M tokens，1,048,576 上下文、131,072 最大輸出，2 個分組可用。

2.8 萬億引數開源旗艦，LMArena 前端程式碼榜登頂，全區間統一計價。
...
以下示例通過 OpenAI Chat Completions（`/v1/chat/completions`）呼叫 `kimi-k3`。base\_url 換成 `https://api.apiyi.com/v1` 即可，其餘用法與官方一致。
...
<CardGroup cols={2}>
  <Card title="上線公告" icon="megaphone" href="/news/kimi-k3-launch">
    Kimi K3 的釋出背景、實測表現與遷移建議
  </Card>

  <Card title="Kimi K2.5" icon="book-open" href="/zh-Hant/api-capabilities/kimi-k2-5">
    引數、呼叫方式與最佳實踐
  </Card>
