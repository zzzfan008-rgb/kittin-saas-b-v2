...
| `ClaudeCodeReverse` | 0.5×        | 50% от цены по прайсу |
...
<CardGroup cols={2}>
  <Card title="Анонс запуска" icon="megaphone" href="/en/news/claude-sonnet-5-launch">
    Сведения о предыстории, результатах тестов и миграции для Claude Sonnet 5
  </Card>
...
<Note>Спецификации на этой странице обновляются вручную в `models/data/model-details.json`; тарифы и эндпоинты поступают из API актуальных тарифов, обновлено 2026-08-31 11:46 (UTC+8), последняя проверка спецификаций выполнена 2026-07-31.</Note>
