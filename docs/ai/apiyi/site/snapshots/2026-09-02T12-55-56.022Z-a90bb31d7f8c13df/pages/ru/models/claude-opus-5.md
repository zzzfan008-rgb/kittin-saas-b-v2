...
| `ClaudeCodeReverse` | 0.5×        | 50% от цены по прайс-листу |
...
<CardGroup cols={2}>
  <Card title="Объявление о запуске" icon="megaphone" href="/en/news/claude-opus-5-launch">
    Сведения о предыстории, результатах тестов и примечания по миграции для Claude Opus 5
  </Card>
...
<Note>Спецификации на этой странице вручную поддерживаются в `models/data/model-details.json`; тарифы и эндпоинты поступают из актуального API тарифов, обновлено 2026-08-31 11:46 (UTC+8), последняя проверка спецификаций — 2026-07-31.</Note>
