...
| `CodexReverse`   | 0.7×        | 70% от цены по прайс-листу |
...
<CardGroup cols={2}>
  <Card title="Анонс запуска" icon="megaphone" href="/en/news/gpt-5-6-launch">
    Сведения о предыстории, результатах тестирования и миграции для GPT-5.6 Терра
  </Card>
  ...
  <Card title="GPT-5.6 Сол" icon="git-compare" href="/ru/models/gpt-5-6-sol">
    Сведения о модели из того же семейства
  </Card>

  <Card title="GPT-5.6 Луна" icon="git-compare" href="/ru/models/gpt-5-6-luna">
    Сведения о модели из того же семейства
  </Card>
