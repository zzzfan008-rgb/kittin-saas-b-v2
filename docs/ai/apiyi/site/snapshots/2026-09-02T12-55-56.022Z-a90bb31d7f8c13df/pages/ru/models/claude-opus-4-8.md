...
<CardGroup cols={2}>
  <Card title="Объявление о запуске" icon="megaphone" href="/en/news/claude-opus-4-8-launch">
    Общая информация, результаты тестов и примечания по миграции для Claude Opus 4.8
  </Card>
...
<Note>Спецификации на этой странице поддерживаются вручную в `models/data/model-details.json`; цены и эндпоинты поступают из актуального API цен, обновлено 2026-08-31 11:46 (UTC+8), спецификации в последний раз проверены 2026-07-31.</Note>
