...
# Gemini 3.6 Flash Генерация текста

> Мультимодальная модель Gemini 3.6 Flash от Google: контекстное окно 1M, четыре уровня рассуждения, полный нативный набор tools. APIYI предлагает как нативный Gemini, так и совместимые с OpenAI эндпоинты по официальной тарификации — $1.50 input / $7.50 output за 1M tokens.
