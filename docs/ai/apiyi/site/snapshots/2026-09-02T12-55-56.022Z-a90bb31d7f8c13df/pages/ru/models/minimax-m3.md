...
<CardGroup cols={2}>
  <Card title="Объявление о запуске" icon="megaphone" href="/en/news/minimax-m3-launch">
    Сведения о предыстории, результатах тестов и примечаниях по миграции для MiniMax-M3
  </Card>
...
<Note>Спецификации на этой странице поддерживаются вручную в `models/data/model-details.json`; тарифы и эндпоинты поступают из API актуальных тарифов, обновлено 2026-08-31 11:46 (UTC+8), спецификации в последний раз проверены 2026-07-31.</Note>
