...
<CardGroup cols={2}>
  <Card title="Анонс запуска" icon="megaphone" href="/en/news/chat-latest-launch">
    Сведения о контексте, результатах тестирования и миграции для chat-latest
  </Card>
...
<Note>Спецификации на этой странице поддерживаются вручную в `models/data/model-details.json`; тарифы и эндпоинты поступают из API актуальных тарифов, обновлено 2026-08-31 11:46 (UTC+8), последняя проверка спецификаций выполнена 2026-07-31.</Note>
