...
<CardGroup cols={2}>
  <Card title="출시 발표" icon="megaphone" href="/en/news/dola-seed-2-1-turbo-launch">
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리합니다. 가격 및 엔드포인트는 실시간 가격 API에서 가져오며, 2026-08-31 11:46 (UTC+8)에 업데이트되었습니다. 사양은 2026-07-31에 마지막으로 확인되었습니다.</Note>
