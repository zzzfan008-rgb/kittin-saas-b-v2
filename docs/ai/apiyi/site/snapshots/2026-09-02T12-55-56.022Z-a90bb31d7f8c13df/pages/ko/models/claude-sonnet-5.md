...
일부 그룹에는 추가 할인이 적용되며, 충전 보너스와 중복 적용할 수 있습니다. [token과 그룹](/ko/faq/token-and-groups)을 참고하십시오.
...
<CardGroup cols={2}>
  <Card title="출시 공지" icon="megaphone" href="/en/news/claude-sonnet-5-launch">
    Claude Sonnet 5의 배경, 벤치마크 및 마이그레이션 참고 사항
  </Card>

  <Card title="Claude API 기본 사항" icon="book-open" href="/ko/api-capabilities/claude">
    매개변수, 사용법 및 모범 사례
  </Card>
...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리됩니다. 과금 및 엔드포인트는 2026-08-31 11:46 (UTC+8)에 업데이트된 실시간 과금 API에서 제공되며, 사양은 2026-07-31에 마지막으로 확인되었습니다.</Note>
