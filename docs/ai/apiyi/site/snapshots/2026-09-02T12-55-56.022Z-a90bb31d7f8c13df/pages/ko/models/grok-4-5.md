...
> APIYI의 Grok 4.5: 100만 token당 입력 $2 / 출력 $6, 500,000 컨텍스트 윈도우, 4개의 과금 그룹에서 제공됩니다.
...
일부 그룹에는 추가 할인 혜택이 있으며, 충전 보너스와 중복 적용할 수 있습니다. [token 및 그룹](/ko/faq/token-and-groups)을 참조하십시오.
...
<CardGroup cols={2}>
  <Card title="출시 공지" icon="megaphone" href="/en/news/grok-4-5-launch">
