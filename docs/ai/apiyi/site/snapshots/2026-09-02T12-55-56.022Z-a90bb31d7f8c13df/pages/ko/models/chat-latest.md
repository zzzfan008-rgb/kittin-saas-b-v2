...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리되며, 과금 및 엔드포인트는 실시간 과금 API에서 제공됩니다. 마지막 업데이트: 2026-08-31 11:46 (UTC+8), 사양 마지막 확인: 2026-07-31입니다.</Note>
