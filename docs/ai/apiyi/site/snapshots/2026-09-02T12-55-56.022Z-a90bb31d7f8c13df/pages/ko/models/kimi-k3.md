...
<Note>이 페이지의 사양은 `models/data/model-details.json`에서 수동으로 관리하며, 과금 및 엔드포인트는 실시간 과금 API에서 가져옵니다. 과금 API는 2026-08-31 11:46 (UTC+8)에 업데이트되었으며, 사양은 2026-07-31에 마지막으로 확인되었습니다.</Note>
