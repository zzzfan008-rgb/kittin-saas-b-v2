              ...
              {editing ? (
                <div className="relative flex min-w-0 flex-1 items-center rounded-md border border-[var(--gc-accent)] bg-[var(--gc-control)] pl-2">
                  ...
                  {renameError && (
                    <span
                      role="alert"
                      className="absolute left-0 top-full z-50 mt-1 whitespace-nowrap rounded-md border border-red-500/40 bg-red-950 px-2 py-1 text-[10px] text-red-200 shadow-lg"
                    >
                      {renameError}
                    </span>
                  )}
